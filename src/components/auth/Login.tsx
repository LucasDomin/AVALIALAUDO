...
export const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (success) {
      ...
      setError('Email não encontrado. Faça o cadastro primeiro.');
    }
  };
      ...
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
        ...
        <div className="mt-6">
          ...
          <button
            ...
            className="w-full mt-4 flex items-center justify-center gap-3 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition"
          >
